...
public class CheckValidationHelper {
	 ...
	 */
	public static CheckValidation getCheckValidation(String namespaceId) {
		CheckValidation checkValidation;
		if ("1000005".equals(namespaceId)) {
			// Danish
			checkValidation = new org.ihtsdo.sct.drugmatch.check.extension.danish.CheckValidationImpl();
		} else {
			// generic
